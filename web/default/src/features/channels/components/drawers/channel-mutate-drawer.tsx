                          ...
                          <div className='divide-border space-y-0 divide-y border-y'>
                            ...
                            {currentType === 1 && (
                              <>
                                ...
                                <FormField
                                  control={form.control}
                                  name='responses_via_chat_enabled'
                                  render={({ field }) => (
                                    <FormItem className='flex items-center justify-between gap-3 px-4 py-3'>
                                      <div className='space-y-0.5'>
                                        <FormLabel className='text-sm'>
                                          {t('Use Chat fallback for Responses')}
                                        </FormLabel>
                                        <FormDescription>
                                          {t(
                                            'Convert /v1/responses requests to /v1/chat/completions for OpenAI-compatible upstreams that do not support Responses'
                                          )}
                                        </FormDescription>
                                      </div>
                                      <FormControl>
